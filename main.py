...
from adv_train import SmallCNN
...
def main(args):
    ...
    # =====================================
    robust_model = SmallCNN().cuda()
    robust_model.load_state_dict(torch.load(args.path))
    args.robust_model = robust_model
    solver = Solver(args)
    solver.train()
    # =====================================
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset', default='CelebA', type=str, help='CelebA or cifar10')
...
"""
CUDA_VISIBLE_DEVICES=3 python3 main.py --dataset cifar10 --seed 1 --lr 1e-4 --beta1 0.9 --beta2 0.999 \
    --objective H --model H --batch_size 64 --z_dim 10 --max_iter 1.5e6 \
    --beta 10 --viz_name celeba_H_beta10_z10 --path=ckpt/resnet18.pkl
"""
